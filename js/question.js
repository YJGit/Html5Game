...
function modifyWithQuestion(i){
  ...
  $choices.eq(0).text("A. " + questionSet.questions[i].choiceA).prev()[0].checked = true;
  $choices.eq(1).text("B. " + questionSet.questions[i].choiceB).prev()[0].checked = false;
  $choices.eq(2).text("C. " + questionSet.questions[i].choiceC).prev()[0].checked = false;
  $choices.eq(3).text("D. " + questionSet.questions[i].choiceD).prev()[0].checked = false;
